  ...
  return (
    <div>
      ...
      <nav
        ...
        {/* Si esta autenticado, muestra el boton de salir */ }
        {
          isAuthenticated && (
            <button className="w-full flex items-center mt-10 p-2 hover:bg-gray-100 rounded transition-all" onClick={ onLogout }>
