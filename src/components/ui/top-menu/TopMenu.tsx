  ...
  return (
    <nav className="flex px-5 justify-between items-center w-full">
      ...
      <div className="hidden sm:block">
        ...
        <Link className="m-2 p-2 rounded-md transition-all hover:bg-gray-300" href="/category/kids">Niños</Link>
      </div>
      ...
      <div className="flex items-center">
        ...
        <button className="m-2 p-2 rounded-md transition-all hover:bg-gray-300">
          Menú
        </button>
      </div>
    </nav>
